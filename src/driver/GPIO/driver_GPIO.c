...
void GPIO_init()
{
    ...
    core_GPIO_init(RTD_BUTTON_PORT, RTD_BUTTON_PIN, GPIO_MODE_INPUT, GPIO_PULLDOWN);
...
bool GPIO_get_RTD() {return core_GPIO_digital_read(RTD_BUTTON_PORT, RTD_BUTTON_PIN);}
